...
CREATE TABLE IF NOT EXISTS users (
  ...
  paper_trading_enabled boolean DEFAULT true,  -- Enable paper trading
  selected_model_ids jsonb DEFAULT '[]'::jsonb,  -- Array of model IDs (as JSONB)
...
CREATE TABLE IF NOT EXISTS models (
  ...
  model_path text,
  stock_symbol text NOT NULL,  -- Stock this model is trained on (REQUIRED)
  model_format text DEFAULT 'joblib',  -- 'joblib' for XGBoost, 'keras' for LSTM/Transformer
...
CREATE INDEX IF NOT EXISTS idx_signals_unexecuted ON signals(executed) WHERE executed = false;
